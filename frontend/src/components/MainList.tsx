                ...
                {data.map((publication) => (
                    ...
                    >
                        ...
                        <div className="flex justify-between p-2 mt-2">
                            <button className="flex items-center gap-2 cursor-pointer"><ChatBubbleBottomCenterIcon className="w-4 h-4 text-yellow-700" />Comentar</button>
                            <button className="flex items-center gap-2 cursor-pointer"><ShareIcon className="w-4 h-4 text-yellow-700"/> Compartir</button>
                        </div>
                    </li>
                ))}
            </ul>
